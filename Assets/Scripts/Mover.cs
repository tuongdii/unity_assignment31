...
public class Mover : MonoBehaviour
{
    ...
    public void Update()
    {
        ...
        // move game object
        // transform.Translate(Vector3.right * directionMultiplier * MoveAmountPerSecond * Time.deltaTime);
        transform.position = new Vector3(transform.position.x + MoveAmountPerSecond * directionMultiplier * Time.deltaTime,transform.position.y,transform.position.z);
    }
